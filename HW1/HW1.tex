...
The problem with this one is that we say $i\gets k$. Given that $OMP$ attempts to slice the problem to available processors it will set i to different values for different threads, which is not the intent of the problem. 
