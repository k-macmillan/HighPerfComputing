...
// 0-16 factorial
uint64_t factorials[19] = { 1, 1, 2, 6, 24, 120, 720, 5040, 40320, 362880, 3628800, 39916800, 479001600, 6227020800,
...
inline bool correctCount(const uint8_t &N, const uint64_t &count){
